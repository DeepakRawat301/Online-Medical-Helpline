...
<body>
    ...
    try {
        ...
        String Pregisterquery = "INSERT INTO patient (UserId, Password, Name, Age, Address, Mob, Mail, Gender, RDate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        prst = cn.prepareStatement(Pregisterquery);
